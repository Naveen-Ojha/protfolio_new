                            ...
                            <Table>
                                ...
                                <TableBody>
                                    {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                                        const { _id, firstname, __v, status, email, avatarUrl, number } = row;
                                        ...
                                        return (
                                            <TableRow hover key={_id} tabIndex={-1} role="checkbox" selected={selectedUser}>
                                                ...
                                                <TableCell align="left">{__v ? 'Yes' : 'No'}</TableCell>
                                                ...
                                                <TableCell align="left">
                                                    <Label align="left">
                                                        <Link to={`/admin/user-details/${_id}`}>View</Link>
                                                    </Label>
                                                </TableCell>
